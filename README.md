...
| REGEXACHE_CACHE_OUTPUT | File to output the cache contents when the application is shutting down. Default: Empty (Don't output cache). |
| REGEXACHE_CACHE_OUTPUT_MIN | Minimum number of lookups to include when listing cache entries. Default: 10. |
